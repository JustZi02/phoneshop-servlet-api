...
public class DemoDataServletContextListener implements ServletContextListener {
    ...
    private void saveSampleProducts() {
        ...
        productDao.save(new Product("sgs3", "Samsung Galaxy S III", new BigDecimal(300), usd, 0, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S%20III.jpg"));
